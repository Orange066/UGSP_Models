...
def train(model, local_rank, start_epoch):
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        for i, data in enumerate(train_data):
            ...
            time_stamp = time.time()
            data_gpu, timestep, flow_gpu, space_mask_gpu, var_gpu = data
            data_gpu = data_gpu.to(device, non_blocking=True) / 255.
            flow_gpu = flow_gpu.to(device, non_blocking=True)
            ...
            pred, pred_c, info = model.update(imgs, gt, flow_gpu, space_mask_gpu, var_gpu, learning_rate, training=True, epoch=epoch,
            ...
            if step % 200 == 1 and local_rank == 0:
                ...
                writer.add_scalar('loss/l1_c', info['loss_l1_c'], step)
                ...
                writer.add_scalar('loss/loss_geo', info['loss_geo'], step)
                writer.add_scalar('loss/loss_dis', info['loss_dis'], step)
            ...
            if step % 1000 == 1 and local_rank == 0:
                ...
                for i in range(5):
                    ...
                    flow_1_tmp, flow_2_tmp, flow_3_tmp = flows_c
                    ...
                    writer.add_image(str(i) + '/flow_c_1', flow1_c, step, dataformats='HWC')
                    writer.add_image(str(i) + '/flow_c_2', flow2_c, step, dataformats='HWC')
                    writer.add_image(str(i) + '/flow_c_3', flow3_c, step, dataformats='HWC')
...
def evaluate(model, val_data, nr_eval, local_rank, writer_val):
    ...
    for i, data in enumerate(val_data):
        ...
        gt = data_gpu[:, 6:9]
        with torch.no_grad():
            pred, pred_c, info = model.update(imgs, gt, flow_gpu, space_mask_gpu, var_gpu, training=False, epoch=epoch,
...
if __name__ == "__main__":
    ...
    if args.resume == True:
        ...
        state = torch.load('/home/user3/ECCV2022-RIFE-33-sparse-l1-wstep-contrast-feat-ifrnet/train_log_32/flownet_state_199.pkl')
        epoch = state["epoch"] + 1
