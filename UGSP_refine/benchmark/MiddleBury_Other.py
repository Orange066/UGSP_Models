...
model.load_model_epoch('train_log', 299)
model.eval()
model.device()
...
for i_count, i in enumerate(name):
    # print('i', i)
    # i0 = cv2.imread('F:/datasets/middlebury/other-data/{}/frame10.png'.format(i)).transpose(2, 0, 1) / 255.
    # i1 = cv2.imread('F:/datasets/middlebury/other-data/{}/frame11.png'.format(i)).transpose(2, 0, 1) / 255.
    # gt = cv2.imread('F:/datasets/middlebury/other-gt-interp/{}/frame10i11.png'.format(i))
    ...
    if count_time == False:
        ...
        flops = flops_0 + flops_1 + flops_2 + 1.9928064 * 2 + 2.5025292 + 0.403776 * 2 + 10.1300736
        print('flops', flops)
    else:
