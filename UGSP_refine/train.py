    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        for i, data in enumerate(train_data):
            ...
            if step % 200 == 1 and local_rank == 0:
                ...
                writer.add_scalar('loss/l1_tea', info['loss_tea'], step)
                writer.add_scalar('loss/loss_distill', info['loss_distill'], step)
            ...
            if step % 1000 == 1 and local_rank == 0:
                ...
                for i in range(5):
                    ...
                    flow_gt_tmp = flow_gt.permute(0, 2, 3, 1).detach().cpu().numpy()
                    ...
                    flow_gt_save = flow2rgb(flow_gt_tmp[i, :, :, :2])
                    flow_gt_tmp = flow2rgb(flow_gt_tmp[i, :, :, 2:4])
                    flow_gt_save = np.concatenate([flow_gt_save, flow_gt_tmp], axis=1)
                    ...
                    writer.add_image(str(i) + '/flow_gt', flow_gt_save, step, dataformats='HWC')
